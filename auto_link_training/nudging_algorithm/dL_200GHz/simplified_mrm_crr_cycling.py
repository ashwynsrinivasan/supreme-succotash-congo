...
def crr_locking_func(crr_resonances_iter, crr_optical_bandwidth, mrm_resonances_iter, laser_frequency, mrm_optical_bandwidth, no_mrm_cycling_steps, no_crr_cycling_steps, mrm_laser_assigned, mrm_heat_assigned, mrm_heat_cycling, step_sweep = 200, debug = 0):
  crr_assigned = []
  crr_laser_assigned = []
  crr_heat_assigned = []
  ...
  if crr_heat_assigned[0] > 00:
    ...
    step_range = [-2-crr_cycling_assigned[-1], 7-crr_cycling_assigned[-1]]
    # step_range = [-2, 7]
